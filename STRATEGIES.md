...
decimal interval from a SHA-256 seed, then samples without replacement. Every
new candidate has at least 1,001 digits, the requested exact size has no
...
every new candidate has the requested size of at least 1,001 decimal digits, is distinct, excludes source
...
inside the requested interval of at least 1,001 digits. Allocation is balanced across all parent/prefix
