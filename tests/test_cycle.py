...
class CycleTests(unittest.TestCase):
    ...
    def test_independent_verification_and_artifacts(self):
        ...
        with tempfile.TemporaryDirectory() as d:
            ...
            for expected in ["Starting integer: `7`", "Repeated integer: `7`", "First seen step: 0", "Repeated at step: 1", "Cycle length: 1", "Pilot: `p`", "Strategy: `s`", "Deterministic seed: `seed`", "Cell: `c`", "Family: `f`", "Generation parameters: `{\"x\": 1}`", "Source metadata: `{\"m\": 2}`", "Validation mode: `v`", "Independent replay confirmed: true", "- `7`"]:
